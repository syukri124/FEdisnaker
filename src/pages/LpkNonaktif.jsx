...
export default function LpkNonaktif() {
  ...
  const handleAddSubmit = (e) => {
    ...
    resetForm();
    Swal.fire('Sukses', 'LPK Tidak Aktif berhasil ditambahkan.', 'success');
  };
  ...
  const handleActivate = (id) => {
    Swal.fire({
      title: 'Aktifkan Kembali LPK?',
      text: 'LPK ini akan dipindahkan ke daftar LPK Aktif.',
      icon: 'warning',
      ...
      if (result.isConfirmed) {
        ...
        saveToLocalStorage(updated);
        Swal.fire('Diaktifkan!', 'Status LPK berhasil diubah menjadi aktif.', 'success');
      }
    });
  };
  ...
  const handleExportExcel = () => {
    ...
    link.setAttribute("download", `Rekap_LPK_Tidak_Aktif_${filterBulan}_${filterTahun}.csv`);
    document.body.appendChild(link);
    link.click();
    document.body.removeChild(link);

    Swal.fire('Export Sukses', 'Berkas rekap LPK Tidak Aktif (.csv) berhasil diunduh.', 'success');
  };
  ...
  const handleImportSubmit = (e) => {
    ...
    const mockRows = [
      { nama_lpk: 'LPK Sentosa Mandiri (Nonaktif)', pimpinan: 'H. Herman', berdiri: 2011, alamat: 'Jl. Kaharuddin Nasution No. 90' }
    ];
    ...
    setImportFile(null);
    Swal.fire('Import Sukses', `Data LPK Tidak Aktif berhasil diimpor.`, 'success');
  };
    ...
    <div>
      ...
      <div className="card card-modern shadow-sm p-4 mb-4">
        <div className="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-3">
          <h5 className="m-0 fw-bold"><i className="fa fa-circle-xmark text-danger me-2"></i>Rekapitulasi LPK Tidak Aktif</h5>
          ...
          <table className="table table-hover table-striped align-middle">
            ...
            <tbody>
              {filteredLpks.length === 0 ? (
                <tr>
                  <td colSpan="8" className="text-center text-muted py-4">Tidak ada data LPK tidak aktif ditemukan.</td>
                </tr>
              ) : (
                filteredLpks.map((item, index) => (
                  <tr key={item.id}>
                    ...
                    <td className="fw-bold text-muted">{item.nama_lpk}</td>
                    ...
                    <td className="text-center">
                      <div className="d-flex justify-content-center gap-1">
                        ...
                        <button className="btn btn-sm btn-outline-success" onClick={() => handleActivate(item.id)} title="Set Aktif Kembali">
              ...
              <div className="modal-content border-0 shadow-lg">
                <form onSubmit={handleAddSubmit}>
                  <div className="modal-header bg-primary text-white">
                    <h5 className="modal-title fw-bold"><i className="fa fa-plus me-2"></i>Tambah Data LPK Tidak Aktif</h5>
                  ...
                  <div className="modal-body">
                    <div className="row g-3">
                      ...
                      <div className="col-6">
                        ...
                        <input type="text" className="form-control bg-light" value="Tidak Aktif" readOnly />
                      </div>
                      <div className="col-12">
